...
<body>
  ...
  <div class="container">
      <h1 class="text-light text-bordered col-6">Crear cuenta</h1>
      <div style="display: flex; justify-content: flex-end">
          <a href="{{route('home.login')}}" class="btn btn-danger btn-lg">Ya tengo cuenta</a>
      </div>
      @if ($errors->any())
      ...
      <form method="POST" action="{{route('cuentas.store')}}">
          ...
          <div class="form-group">
              <label class="text-light text-bordered" for="user">Usuario</label>
              <input type="text" id="user" name="user" class="form-control col-3 @error('user') is-invalid @enderror" value="{{ old('user') }}">
          </div>
          ...
          <button type="submit" class="btn btn-danger mt-3">Crear cuenta</button>
